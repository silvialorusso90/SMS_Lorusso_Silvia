...
public class Downloader_r_p extends AsyncTask<Void,Void,String> {
    ...
    public Downloader_r_p(Context c, String url, RecyclerView rv) {
        this.c = c;
        this.url = url;
        this.rv = rv;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if(s == null){
            ...
            //CALL DATA PARSER
            Parser_r_p parser = new Parser_r_p(c, s, rv);
            parser.execute();
        }
    }
