...
public class Downloader_v_m extends AsyncTask<Void,Void,String> {
    ...
    public Downloader_v_m(Context c, String url, RecyclerView rv) {
        this.c = c;
        this.url = url;
        this.rv = rv;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if(s == null){
            ...
            //PARSER
            Parser_v_m parser = new Parser_v_m(c, s, rv);
            parser.execute();
        }
    }
